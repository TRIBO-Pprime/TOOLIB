...
contains
   ...
   type(MAT_SOLV), intent(inout) :: mat   !! *high level system type*
      ...
      if ( allocated( mat%eltvar ) ) deallocate( mat%eltvar )
   ...
   type(MAT_SOLV), intent(inout), target :: mat   !! *high level system type*
      ...
      !-----------------------------------------------------------
      call sort_array2(tab_inout =  jcol(1:ntot),           &  !
                            tab1 =  irow(1:ntot),           &  !
                            tab2 = a_elt(1:ntot), n = ntot)    !
      ...
      do i = 1, n
         i1 = jptr(i)
         i2 = jptr(i +1) -1
         call sort_array2(tab_inout =   irow(i1:i2),                     &  !
                               tab1 =  a_elt(i1:i2), n = i2 - i1 +1 )       !
